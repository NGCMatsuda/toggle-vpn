...
if vpnConnectionInProgress is true then
	display notification "" with title "Connection Staeted!" subtitle "You may now browse the internet privately and securely"
else
	display notification "" with title "Connection Terminated!" subtitle "You may now browse the internet as public"
end if
